...
![image1]({{ "/assets/DB/days02/image1.png" | absolute_url }})  
`SELECT * FROM all_users;`   
![image2]({{ "/assets/DB/days02/image2.png" | absolute_url }})  


**2. dba_users**  
DB의 모든 계정을 출력하는건 all_users와 같지만 출력하는 컬럼 수가 훨씬 많다. 비밀번호는 출력안됨...  
![image3]({{ "/assets/DB/days02/image3.png" | absolute_url }})  

SYS계정에서만 접근할 수 있다.  
`SELECT * FROM dba_users;`   
![image4]({{ "/assets/DB/days02/image4.png" | absolute_url }})  


3. user_users
현재 사용자의 관한 정보를 출력  
![image5]({{ "/assets/DB/days02/image5.png" | absolute_url }})   
`SELECT * FROM user_users;`  
![image6]({{ "/assets/DB/days02/image6.png" | absolute_url }})  
...
WHERE GRANTEE = 'SCOTT';
```
![image7]({{ "/assets/DB/days02/image7.png" | absolute_url }})  
...
WHERE OWNER = 'SCOTT';
```
![image8]({{ "/assets/DB/days02/image8.png" | absolute_url }})  
...
WHERE GRANTEE = 'SCOTT';
```
![image9]({{ "/assets/DB/days02/image9.png" | absolute_url }})  
...
`WITH ADMIN OPTION` 은 해당 시스템 권한을 _다른 사용자나 롤에 재부여를 허용_
...
<table class="tg">
  <tr>
    <th class="tg-0pky">비교연산자</th>
    <th class="tg-0pky">설명</th>
    <th class="tg-0pky">USER IS "HR"</th>
  </tr>
  <tr>
    <td class="tg-0pky">=</td>
    <td class="tg-0pky">같다</td>
    <td class="tg-dvpl">SQL&gt; select * from employees<br>where salary = 2500<br></td>
  </tr>
  <tr>
