...
```sh
ssh-keygen -t rsa -b 4096 -f ~/.ssh/id_rsa_deploy_jenkins -C "jenkins@yourcompany"
# id_rsa_deploy_jenkins.pub 값을 인증목록에 추가
echo "ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAABAQDf4xk2..." >> ~/.ssh/authorized_keys
```
