...
스프링 프레임워크를 배우고 진행한 간단한 설문조사 사이트 구축

### 사용 기술  

* Spring tiles를 이용한 모듈화  
* Spring Security를 이용한 비밀번호 암호화  
* 이메일을 통한 비밀번호 찾기  
* Ajax를 이용한 회원가입, 회원정보 변경 처리  
...
* 스프링을 사용하면서 JSP/Servlet에서 발생했던 잔버그가 사라졌다.(db close작업 등)  
* git을 사용한 협업이 더 간단해졌다.    
